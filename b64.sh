...
mkdir ${BUILD}/bx64
cd ${BUILD}/bx64
CPPFLAGS='-D_WIN64 -DWIDE_EMACS_INT -DGLYPH_DEBUG=1' CFLAGS='-O0 -g3' ${SRC}/nt/msysconfig.sh --with-xml2 --host=x86_64-w64-mingw32 --enable-checking >> ${BUILD}/$logfilename 2>&1
